...
-->
        ...
        <xsl:for-each select="marc:datafield[@tag=592]">
            <xsl:call-template name="createNoteFrom592"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag=501 or @tag=507 or @tag=513 or @tag=514 or @tag=516 or @tag=522 or @tag=525
			or @tag=526 or @tag=544 or @tag=547 or @tag=550 or @tag=552 or @tag=555 or @tag=556 or @tag=565 or @tag=567 or
			@tag=580 or @tag=584 or @tag=586]">
        ...
        <!-- for lindsey ryrie-campbell -->
        <xsl:for-each select="marc:datafield[@tag='090']">
            <xsl:if test="marc:subfield[@code='a']">
                <identifier type="call number">
                    <xsl:value-of select="marc:subfield[@code='a']"/>
                </identifier>
            </xsl:if>
        </xsl:for-each>
...
-->
            ...
            <!-- for ryrie-campbell -->
            <xsl:when test="//marc:datafield[@tag='592']">
                <xsl:call-template name="createNoteFrom592"/>
            </xsl:when>
...
-->
    ...
    <!-- added donor note for Ryrie-Campbell -->
    <xsl:template name="createNoteFrom592">
        <note type="donor">
            <xsl:call-template name="xxx880"/>
            <xsl:call-template name="uri"/>
            <xsl:variable name="str">
